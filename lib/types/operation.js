...
Operation.prototype.setContentTypes = function (args, opts) {
  ...
  var body;
  var consumes = opts.responseContentType || itemByPriority(this.produces, ['application/json', 'application/yaml']);
  ...
  if (true || this.method === 'post' || this.method === 'put' || this.method === 'patch' || this.method === 'get' ||
